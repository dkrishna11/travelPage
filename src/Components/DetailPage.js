      ...
      {post && (
        <div className="user-details">
          ...
          <div className="useData">
            <button className="Details" onClick={()=>setDetails(false)}>Details</button>
            <button className="User-Info" onClick={() => setUser(true)}>
              User Info
            </button>
            ...
            {
                user && <p>Post Was Posted By {post.userId}</p>
            }
          </div>
        </div>
      )}
